          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  Kenya Movers AI provides an online platform that connects customers with professional 
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  All content, trademarks, logos, and intellectual property on the Kenya Movers AI platform 
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  To the maximum extent permitted by Kenyan law, Kenya Movers AI shall not be liable for:
                </p>
                <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
              ...
              <section>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    <strong>Address:</strong> Kenya Movers AI<br />
